...
<body>
    <div class="header">
        ...
        <p>Rekap Presensi Harian — {{ $bulan_nama }} {{ $tahun }}</p>
    ...
    <div class="info">
        <table>
            ...
            <tr><td>Periode</td><td>: {{ $bulan_nama }} {{ $tahun }}</td></tr>
            <tr><td>Total Hari Belajar</td><td>: {{ $total_hari }} hari</td></tr>
    ...
    <table class="data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="center {{ $s['alpha'] >= 5 ? 'kritis' : '' }}">{{ $s['alpha'] }}</td>
                <td class="center">{{ $s['total'] }}</td>
                <td class="center {{ $s['persen'] >= 85 ? 'baik' : ($s['persen'] < 70 ? 'kritis' : '') }}">{{ $s['persen'] }}%</td>
            </tr>
            @endforeach
        </tbody>
    </table>
